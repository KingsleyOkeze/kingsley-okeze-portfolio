...
function Home () {
    ...
    const [projects, setProjects] = useState([
        {
            ...
            description: `This is an Admin web app for an e-commerce brand, it's designed to give the store owner 
            full control and visibility into their platform. The dashboard acts as the control center for the entire 
            store. Whether it's updating an order's status or tracking customer behavior, this tool makes managing an 
            e-commerce brand 10x easier. Built with: React, Node.js, MongoDB, and CSS.`
        },
        {
            image: [dmanEcom1, dmanEcom2, dmanEcom3], 
            url: "https://dman-officials-ecommerce-store.vercel.app",
            description: `Developed a user-centric e-commerce platform with a clean, mobile-responsive 
            UI to ensure a seamless and secure shopping experience. The application features a streamlined 
            checkout, intuitive product discovery with advanced filtering, and a robust user authentication system. 
            This project showcases my ability to build a high-performance front-end that drives customer engagement and loyalty.`
        }
    ]);
    ...
    // Close menu when clicking outside or resizing to larger screens
    useEffect(() => {
        const handleResize = () => {
    ...
    return (
        <div className="text-white bg-19191B p-5 lg:p-10 bg-gradient-to-b from-[#0E0E1A] to-[#080812]">
            <div className="flex justify-between align-middle relative">
                ...
                <a href="#contact">
                    <button className="hidden cursor-pointer sm:block py-1 px-5 border-2 rounded-sm">
                        Contact
                    </button>
                </a>
                <img
            ...
            <div className="md:flex md:justify-between mt-10">
                <div className="flex flex-col justify-between mt-0 mb-20 md:mb-0 md:basis-[50%]">
                    <p className="font-medium leading-normal w-10/12 md:w-9/12 mb-5 text-4xl sm:text-3xl md:text-4xl sm:w-6/12 sm:z-21">Creating Products That Truly Matter</p>
                    ...
                    <p>
                        Want the full story? Grab my resume below, consider it the director’s cut 🎬.
                    </p>
                    <p>
                        It’s packed with my experience, tech stack, and the kind of impact I can bring to you.
                    </p>
                    <button 
                ...
                <div className="relative w-full h-120 md:h-130 mx-auto flex items-center justify-center my-25 sm:my-0 md:basis-[55%]">
                    <div className="bg-transparent border-2 w-[75%] md:w-[75%] lg:w-[90%] h-[245px] md:h-[245px] lg:h-[300px] max-w-[430px] max-h-[300px] rotate-10 
                        absolute left-5 md:left-5 lg:left-0 xl:left-10 sm:left-20 sm:w-80 sm:h-85 rounded-2xl">

                    </div>
                    <div className="bg-[#5454D4] w-[70%] md:w-[75%] lg:w-[90%] h-[245px] md:h-[245px] lg:h-[300px] max-w-[430px] max-h-[300px] absolute top-30 md:top-30
                    rotate-11 translate-y-15 -translate-x-0 z-10 sm:h-85 sm:top-10
                    sm:w-80 rounded-2xl">
            ...
            <div id="about" className="flex flex-col justify-between sm:flex-row sm:justify-between sm:my-20 mb-25">
                ...
                <p className="w-12/12 sm:w-6/12 text-sm leading-normal sm:text-base">I combine technical expertise with a builder’s mindset. 
                    I don’t just deliver features, I deliver outcomes.  
                    My code is scalable, my designs are user-focused, and my approach is all about 
                    helping businesses grow. If you’re looking for someone who takes ownership, 
                    adapts fast, and loves turning ideas into polished products — that’s me.
            ...
            <div id="services" className="relative font-medium text-3xl text-center sm:text-center sm:w-9/12 mx-auto">
                <p>My Specialties</p>
                <img 
                    className="sm:hidden absolute -top-5"
                    src={play} 
                    width={40} 
                    height={50} 
                    alt="play image" 
                />
                <img 
                    className="sm:hidden absolute -bottom-7 right-2 rotate-30"
                    src={add} 
                    width={30} 
                    height={50} 
                    alt="play image" 
            ...
            <div className="basis-full sm:basis-[30%] p-6 rounded-lg shadow-lg text-center">
                ...
                <p className="text-sm leading-normal sm:text-base">
                    From pixel-perfect frontends to scalable backends, I build web applications 
                    that don’t just look good — they perform flawlessly. 
                    Clean, maintainable, and optimized for growth.
                </p>
            </div>
            ...
            <div className="basis-full sm:basis-[30%] p-6 rounded-lg shadow-lg text-center">
                ...
                <p className="text-sm leading-normal sm:text-base">
                    Mobile is where your users live. I craft responsive, intuitive apps that work seamlessly 
                    across devices, ensuring your brand is always in their hands.
                </p>
            </div>
            ...
            <div className="basis-full sm:basis-[30%] p-6 rounded-lg shadow-lg text-center">
                ...
                <p className="text-sm leading-normal sm:text-base">
                    AI isn’t the future, it’s here. I develop AI-powered apps that integrate 
                    large language models into real products, helping businesses automate, 
                    scale, and innovate faster than ever.
                </p>
            </div>
        </div>
            <div>
                ...
                <div className="sm:w-11/12 mx-auto my-10 grid grid-cols-[repeat(auto-fit,_minmax(250px,_1fr))] gap-6">
                    {projects.map((project, projectIndex) => {
                        ...
                        // Pause/resume interval on hover
                        ...
                        return (
                            <div
                                key={projectIndex}
                                className="bg-white/15 p-4 rounded-lg min-h-[378px] sm:min-h-[378px] cursor-pointer flex flex-col justify-between"
                            ...
                            >
                                ...
                                <p className="text-sm leading-normal sm:text-bas min-h-[120px] sm:min-h-[180px] break-words pt-4">
                                    {project.description}
                                </p>
                            </div>
                        );
                ...
                {/* <div className="block text-center sm:hidden space-x-4">
                    <button className="bg-white/15 w-12 h-12 rounded-3xl cursor-pointer"> - </button>
                    <button className="bg-blue-600 w-12 h-12 rounded-3xl cursor-pointer"> - </button>
                </div> */}
            </div>
            <div id="contact" className="bg-white/15 h-60 grid place-items-center sm:w-80 mx-auto rounded-3xl my-15">
                <div className="flex flex-col h-47 justify-between text-center">
                    ...
                    <div className="flex flex-row justify-between w-35 mx-auto">
                        <a href="https://www.linkedin.com/in/kingsley-okeze-b4b825263/" target="_blank">
            ...
            <footer className="h-15 text-center flex flex-col justify-between mt-20 mb-10">
                &copy; {year} <p>All right reserved</p>
            </footer>
        </div>
    )
}
